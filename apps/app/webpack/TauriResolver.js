...
module.exports = class TauriResolvePlugin {
  apply(resolver) {
    // match any *.desktop.tsx and *.desktop file
    const tauriPattern = /\.desktop(\.tsx|)$/;
    ...
    resolver.getHook('described-resolve').tapAsync('TauriResolvePlugin', (request, resolveContext, callback) => {
      ...
      const chooseEmpty = (!isTauri && isDesktopFile) || (isTauri && isWebFile);
